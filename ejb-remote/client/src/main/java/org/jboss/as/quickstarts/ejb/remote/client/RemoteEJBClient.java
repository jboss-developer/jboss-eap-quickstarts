...
public class RemoteEJBClient {
    ...
    private static RemoteCalculator lookupRemoteStatelessCalculator() throws NamingException {
        ...
        // let's do the lookup
        return (RemoteCalculator) context.lookup("ejb:/qs-ejb-remote-server-side/CalculatorBean!"
    ...
    private static RemoteCounter lookupRemoteStatefulCounter() throws NamingException {
        ...
        // let's do the lookup
        return (RemoteCounter) context.lookup("ejb:/qs-ejb-remote-server-side/CounterBean!"
