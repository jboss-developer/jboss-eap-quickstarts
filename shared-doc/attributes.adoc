...
:CDProductName: JBoss Enterprise Application Platform for OpenShift
:CDProductShortName: {ProductShortName} for OpenShift
:CDProductTitle: JBoss Enterprise Application Platform for OpenShift
:CDProductNameSentence: Openshift release for {ProductShortName}
:CDProductAcronym: JBoss EAP for OpenShift
:CDProductVersion: 7.3
...
:ImageandTemplateImportURL: https://raw.githubusercontent.com/jboss-container-images/jboss-eap-7-openshift-image/EAP_730_SP01/templates/
...
:githubRepoUrl: https://github.com/jboss-developer/jboss-eap-quickstarts/tree/7.3.x-openshift/
:jbossHomeName: EAP_HOME
...
//:DocInfoProductNumber: {productVersion}
//:quickstartDownloadName: JBoss EAP for Openshift {productVersion} Quickstarts
