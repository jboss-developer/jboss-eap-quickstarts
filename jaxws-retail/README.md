...
Level: Beginner  
Technologies: JAX-WS  
Summary: The `jaxws-retail` quickstart is a working example of the web service discussed in section,
`Write and Deploy a JAX-WS Web Service Endpoint` of the `JBoss Development Application Platform Development Guide`.
Target Product: EAP  
...
3. Type this command to run the client.
     ...
     java -jar client/target/jboss-jaxws-retail-client.one-jar.jar  org.jboss.quickstarts.ws.client.Client
