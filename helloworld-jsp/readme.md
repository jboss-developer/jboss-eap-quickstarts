...
This will deploy `target/jboss-as-helloworld-jsp.war`.
 
The application will be running at the following URL <http://localhost:8080/jboss-as-helloworld-jsp/>.
