...
public class HATimerService implements Service<String> {
    ...
    public void start(StartContext arg0) throws StartException {
        ...
        try {
            ...
            ((Scheduler) ic.lookup("global/qs-cluster-ha-singleton-service/SchedulerBean!org.jboss.as.quickstarts.cluster.hasingleton.service.ejb.Scheduler"))
    ...
    public void stop(StopContext arg0) {
        if (!started.compareAndSet(true, false)) {
            ...
            try {
                InitialContext ic = new InitialContext();
                ((Scheduler) ic.lookup("global/qs-cluster-ha-singleton-service/SchedulerBean!org.jboss.as.quickstarts.cluster.hasingleton.service.ejb.Scheduler")).stop();
            } catch (NamingException e) {
