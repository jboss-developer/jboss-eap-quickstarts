...
3. When you are finished testing, type the following commands to undeploy the archives:
        ...
        mvn wildfly:undeploy [-Dwildfy.hostname=OTHERHOST] -Dwildfy.port=10099
