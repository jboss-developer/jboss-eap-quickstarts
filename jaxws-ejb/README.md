...
Level: Beginner  
Technologies: JAX-WS  
Summary: The `jaxws-ejb` quickstart is a working example of the web service discussed in section,
...
3. Type this command to run the client.
     ...
     java -jar client/target/jboss-jaxws-ejb-client.one-jar.jar  org.jboss.quickstarts.ws.client.Client
