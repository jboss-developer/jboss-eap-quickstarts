...
Any Java class which has a no-args constructor and is in an archive with a `beans.xml` is available for lookup and injection. For EL resolution, it must contain `@Named`.
