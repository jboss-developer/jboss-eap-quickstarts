...
test('should only allow names with alpha characters, an apostrophe, or a dash in them.', 8, function() {
    // well formed names
    ok(APPMODULE.validation.validateName('john'), 'john is well formed');
    ok(APPMODULE.validation.validateName('John'), 'John is well formed');
    ok(APPMODULE.validation.validateName('smith-jones'), 'smith-jones is well formed');
    ok(APPMODULE.validation.validateName("O'Maley"), "O'Maley is well formed");
    
    // mal-formed names
    ok(!APPMODULE.validation.validateName('John Smith'), 'John Smith is not well formed. It has a space in it.');
    ok(!APPMODULE.validation.validateName('john3'), 'john3 is not well formed. No numbers allowed.');
    ok(!APPMODULE.validation.validateName('3'), '3 is not well formed. No numbers allowed.');
    ok(!APPMODULE.validation.validateName('john$'), 'john$ is not well formed. No specials allowed.');
});
...
test('should display an error message in the email field when the email is not unique.', 1, function() {
	APPMODULE.validation.displayServerSideErrors("#contacts-add-form", {email:"That email is already used, please use a unique email"});
...
test('should continue to display an error message in the email field when the email is not unique.', 1, function() {
	...
	$('#contacts-add-input-date').val     ('1990-10-10')
	APPMODULE.validation.displayServerSideErrors("#contacts-add-form", {email:"That email is already used, please use a unique email"});
	APPMODULE.validation.formEmail = 'john.doe@abc.com';
	APPMODULE.validation.addContactsFormValidator.form();
	strictEqual($('label.error').text(), "That email is already used, please use a unique email.", 'The email was set to john.doe@abc.com.');
...
test('should display an error message in the email field when the email is not unique.', 1, function() {
	APPMODULE.validation.displayServerSideErrors("#contacts-edit-form", {email:"That email is already used, please use a unique email"});
	strictEqual($('label.error').text(), "That email is already used, please use a unique email", 'The email was set to john.doe@abc.com.');
});
