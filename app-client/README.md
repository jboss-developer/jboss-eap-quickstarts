...
5. Deploy the `app-client` quickstart to the remote machine using the following command:
        ...
        mvn clean install wildfly:deploy -Djboss-as.hostname=MACHINE_1_IP_ADDRESS [-Djboss-as.port=9099] -Djboss-as.username=admin -Djboss-as.password=admin-123
...
3. When you are finished testing, type this command to undeploy the archive from the remote server machine, `Machine_1`.
        ...
        mvn wildfly:undeploy -Djboss-as.hostname=MACHINE_1_IP_ADDRESS [-Djboss-as.port=9099] -Djboss-as.username=admin -Djboss-as.password=admin-123
