...
This quickstart demonstrates using transactions managed by the container. It is a fairly typical 
...
2. _jts-distributed-crash-rec_ - The crash recovery quickstart builds upon the _jts_ quickstart by demonstrating the 
...
* Required - As demonstrated in the quickstart. If a transaction does not already exist, 
