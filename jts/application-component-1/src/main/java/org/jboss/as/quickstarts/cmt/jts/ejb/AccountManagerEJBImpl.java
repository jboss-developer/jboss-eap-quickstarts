...
@RemoteHome(AccountManagerEJBHome.class)
@Stateless
public class AccountManagerEJBImpl {
    @EJB
    private CustomerManagerEJBHome customerManagerHome;
    ...
    public void createCustomerAndInvoice(String name) throws RemoteException, NamingException {
        final CustomerManagerEJB customerManager = customerManagerHome.create();
