...
targetNamespace="http://www.jboss.com/jbossas/quickstarts/wshelloworld/HelloWorld")
public class HelloWorldServiceImpl implements HelloWorldService {
	...
	/**
	 * Creates a list of names separated by commas or an
	 * and symbol if its the last searation. This is then
	 * used to say hello to the list of names.
	 * 
	 * i.e. if the input was {John, Mary, Luke} the output
	 * would be John, Mary & Luke
	 * 
	...
	private String createNameListString(final List<String> names) {
		...
		/* 
		 * If the list is null or empty then assume the call
		 * was anonymous.
		 */
		...
		for (int i = 0; i < names.size(); i++) {
			...
			/*
			 *  Add the separator if its not the first string 
			 *  or the last separator since that should be an
			 *  and (&) symbol.
			 */
