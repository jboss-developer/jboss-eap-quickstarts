...
The Kitchensink WAR example was created to demonstrate the use of key Java EE 6 technologies like 
JSF, CDI, EJB, JPA, JAX-RS and Bean Validation in a concise and understandable manner.  
