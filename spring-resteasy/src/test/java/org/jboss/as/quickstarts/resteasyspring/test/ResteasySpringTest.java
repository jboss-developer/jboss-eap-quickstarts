        ...
        try {
            {
                URI uri = new URIBuilder()
                    ...
                    .setPath("/qs-spring-resteasy/hello")
            ...
            {
                HttpGet method = new HttpGet("http://localhost:8080/qs-spring-resteasy/basic");
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_OK, response.getStatusLine().getStatusCode());
            ...
            {
                HttpPut method = new HttpPut("http://localhost:8080/qs-spring-resteasy/basic");
            ...
            }
            {
                URI uri = new URIBuilder()
                    .setScheme("http")
                    .setHost("localhost:8080")
                    .setPath("/qs-spring-resteasy/queryParam")
            ...
            {
                HttpGet method = new HttpGet("http://localhost:8080/qs-spring-resteasy/matrixParam;param=matrix");
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_OK, response.getStatusLine().getStatusCode());
            ...
            {
                HttpGet method = new HttpGet("http://localhost:8080/qs-spring-resteasy/uriParam/1234");
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_OK, response.getStatusLine().getStatusCode());
        ...
        try {
            {
                URI uri = new URIBuilder()
                    .setScheme("http")
                    .setHost("localhost:8080")
                    .setPath("/qs-spring-resteasy/locating/hello")
                    .setParameter("name", "JBoss Developer")
                    .build();
                HttpGet method = new HttpGet(uri);
                CloseableHttpResponse response = client.execute(method);
            ...
            {
                HttpGet method = new HttpGet("http://localhost:8080/qs-spring-resteasy/locating/basic");
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_OK, response.getStatusLine().getStatusCode());
                    Assert.assertTrue(EntityUtils.toString(response.getEntity()).contains("basic"));
            ...
            {
                HttpPut method = new HttpPut("http://localhost:8080/qs-spring-resteasy/locating/basic");
                method.setEntity(new StringEntity("basic", ContentType.TEXT_PLAIN));
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_NO_CONTENT, response.getStatusLine().getStatusCode());
            ...
            }
            {
                URI uri = new URIBuilder()
                    .setScheme("http")
                    .setHost("localhost:8080")
                    .setPath("/qs-spring-resteasy/locating/queryParam")
                    .setParameter("param", "hello world")
                    .build();
                HttpGet method = new HttpGet(uri);
                CloseableHttpResponse response = client.execute(method);
            ...
            {
                HttpGet method = new HttpGet("http://localhost:8080/qs-spring-resteasy/locating/matrixParam;param=matrix");
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_OK, response.getStatusLine().getStatusCode());
                    Assert.assertTrue(EntityUtils.toString(response.getEntity()).equals("matrix"));
            ...
            {
                HttpGet method = new HttpGet("http://localhost:8080/qs-spring-resteasy/locating/uriParam/1234");
                CloseableHttpResponse response = client.execute(method);
                try {
                    Assert.assertEquals(HttpResponseCodes.SC_OK, response.getStatusLine().getStatusCode());
                    Assert.assertTrue(EntityUtils.toString(response.getEntity()).equals("1234"));
