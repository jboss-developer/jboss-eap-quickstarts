...
public class JavaClassImpl extends AbstractJavaSource<JavaClass> implements JavaClass
{
   ...
   public JavaClassImpl(char[] source)
   {
      super(source);
   }

   public JavaClassImpl(InputStream inputStream)
   {
      super(inputStream);
   }

   public JavaClassImpl(String source)
   {
      super(source);
   }
   ...
   @Override
   protected JavaClass updateConstructorNames()
   {
