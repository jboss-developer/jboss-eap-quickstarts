kitchensink-cdi-listener-decorator: Upgrades the KitchenSink example using CDI Interceptors and Decorators
========================
...
4. This will deploy `target/kitchensink-cdi-listener-decorator.war` to the running instance of the server.
 

Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/kitchensink-cdi-listener-decorator/>.
