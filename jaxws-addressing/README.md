...
Level: Beginner  
Technologies: JAX-WS  
Summary: The `jaxws-addressing` quickstart is a working example of the web service discussed in section,
`Enable Web Services Addressing (WS-Addressing)` of the `JBoss Development Application Platform Development Guide`.
Target Product: EAP  
...
3. Type this command to run the client.
     ...
     java -jar client/target/jboss-jaxws-addressing-client.one-jar.jar  org.jboss.quickstarts.ws.jaxws.samples.wsa.AddressingTestCase
