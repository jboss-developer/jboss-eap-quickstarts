...
public class AsynchronousClient {
    ...
    private AsynchronousClient() throws NamingException {
        ...
        String lookupName = "ejb:/qs-ejb-asynchronous-ejb/AsynchronousAccessBean!" + AsynchronousAccess.class.getName();
        LOGGER.info("Lookup Bean >" + lookupName);
        accessBean = (AsynchronousAccess) context.lookup(lookupName);
        lookupName = "ejb:/qs-ejb-asynchronous-ejb/ParallelAccessBean!" + ParallelAccess.class.getName();
        LOGGER.info("Lookup Bean >" + lookupName);
