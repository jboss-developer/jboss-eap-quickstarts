...
{
   /**
    * Get the default Web Root directory (this is the {@link DirectoryResource}
    * containing resources to be deployed to the web-root URL when the
    * application is published. (E.g. In a maven project, files in the
    * <code>/project/src/main/webapp</code> directory are typically published to
    * the root URL: <code>http://localhost:8080/project/</code> root directory.
    * In an eclipse project, this folder is typically located by default at:
    * <code>/project/WebContent/</code>.)
    */
   DirectoryResource getWebRootDirectory();

   /**
    * Get a list containing all possible Web Root {@link DirectoryResource}s for
    * the current project.
    */
    ...
    * {@link #getWebRootDirectory()} - create a {@link FileResource} containing
    * the given bytes.
    * 
   ...
   /**
    * Get the given {@link FileResource} relative to the project Web Root
    * directory: {@link #getWebRootDirectory()}
    */
