...
public class JsfController {
     ...
     */
    @Resource(mappedName = "ejb:qs-ejb-multi-server-app-main/ejb/MainAppSContextBean!org.jboss.as.quickstarts.ejb.multi.server.app.MainApp")
     ...
     */
    @Resource(lookup = "ejb:qs-ejb-multi-server-app-one/ejb//AppOneBean!org.jboss.as.quickstarts.ejb.multi.server.app.AppOne")
    AppOne oneApp;
     ...
     */
    @Resource(mappedName = "ejb:qs-ejb-multi-server-app-two/ejb//AppTwoBean!org.jboss.as.quickstarts.ejb.multi.server.app.AppTwo")
    AppTwo twoApp;
