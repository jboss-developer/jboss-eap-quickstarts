...
public class MainAppBean implements MainApp {
    ...
    @EJB(lookup = "ejb:qs-ejb-multi-server-app-one/ejb//AppOneBean!org.jboss.as.quickstarts.ejb.multi.server.app.AppOne")
    AppOne appOneProxy;
    @EJB(lookup = "ejb:qs-ejb-multi-server-app-two/ejb//AppTwoBean!org.jboss.as.quickstarts.ejb.multi.server.app.AppTwo")
    AppTwo appTwoProxy;
    ...
    public String invokeAll(String text) {
        ...
        try {
            lookup = "ejb:qs-ejb-multi-server-app-two/ejb//AppTwoBean!" + AppTwo.class.getName();
     ...
     * <i>ejb:qs-ejb-multi-server-app-two/ejb//AppTwoBean!org.jboss.as.quickstarts
