...
public class MainAppSContextBean implements MainApp {
    ...
    private String invokeAppOne(String text) {
        try {
            ...
            final AppOne bean = (AppOne) appOneScopedEjbContext.lookup("qs-ejb-multi-server-app-one/ejb//AppOneBean!" + AppOne.class.getName());
    ...
    private String invokeAppTwo(String text) {
        ...
        try {
            beanA = (AppTwo) appTwoScopedEjbContextA.lookup("qs-ejb-multi-server-app-two/ejb//AppTwoBean!" + AppTwo.class.getName());
        } catch (NamingException e) {
            LOGGER.error("Could not create InitialContext('appTwoA')");
        }

        try {
            beanB = (AppTwo) appTwoScopedEjbContextB.lookup("qs-ejb-multi-server-app-two/ejb//AppTwoBean!" + AppTwo.class.getName());
        } catch (NamingException e) {
    ...
    private String invokeAppTwoAlternative(String text) {
        ...
        try {
            ...
            beanA = (AppTwo) iCtxA.lookup("qs-ejb-multi-server-app-two/ejb//AppTwoBean!" + AppTwo.class.getName());
        } catch (NamingException e) {
            LOGGER.error("Could not create InitialContext('appTwoA')");
        }
        ...
        try {
            ...
            beanB = (AppTwo) iCtxB.lookup("qs-ejb-multi-server-app-two/ejb//AppTwoBean!" + AppTwo.class.getName());
        } catch (NamingException e) {
            LOGGER.error("Could not create InitialContext('appTwoB')");
        }
