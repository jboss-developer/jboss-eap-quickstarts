 ...
 * @author glamperi
 * added changes to use a local wsdl as the addition of httpconduit via java or cxf.xml is more time consuming
 * TBD: use a cxf.xml to set the httpconduit.
 */
public class ClientTest {
    ...
    private static final String PROXY_WSDL_PATH = "?wsdl";
    ...
    public void setup() {
        try {
            System.out.println("before call to ClientWS");
            //client = new ClientWS(new URL(deploymentUrl, PROXY_WSDL_PATH));
            client = new ClientWS("file:///Users/glamperi/Desktop/Dev/jboss-eap-6.1.0.GA-quickstarts/helloworld-ws/src/main/webapp/WEB-INF/lib/secure-fuse.wsdl");
