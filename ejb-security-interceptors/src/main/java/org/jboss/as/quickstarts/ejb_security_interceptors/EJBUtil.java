...
class EJBUtil {
    ...
    static IntermediateEJBRemote lookupIntermediateEJB() throws Exception {
        ...
        return (IntermediateEJBRemote) context.lookup("ejb:/qs-ejb-security-interceptors/IntermediateEJB!"
    ...
    static SecuredEJBRemote lookupSecuredEJB() throws Exception {
        ...
        return (SecuredEJBRemote) context.lookup("ejb:/qs-ejb-security-interceptors/SecuredEJB!"
