...
7. Follow the steps above to restart server 1 and wait for recovery to complete.
    ...
    * _NOTE:_ You will also get several stack traces in JBoss EAP server 1 console during recovery, these are to be expected as not all resources are available at all stages of recovery.
