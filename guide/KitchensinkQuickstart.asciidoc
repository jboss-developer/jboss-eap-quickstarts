...
If you want to define your own datasource, take a look at the link:https://access.redhat.com/documentation/en/jboss-enterprise-application-platform/[Product Documentation] for Red Hat JBoss Enterprise Application Platform or the link:https://docs.jboss.org/author/display/WFLY10/Getting+Started+Guide[Getting Started Guide].
