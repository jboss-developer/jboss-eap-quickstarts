...
This quickstart shows you how to deploy a simple servlet to Red Hat JBoss Enterprise Application Platform 6. The business logic is encapsulated in a service, which is provided as a CDI bean, and injected into the Servlet.
